...
| `type`              | yes      | `"device"` (publishes discovered devices) or `"communication"` (messaging channel: sends and receives messages for linked users, Configuration screen only)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
